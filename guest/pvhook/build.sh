...
( cd build && $W wcc -bt=windows -bd -ms -zW -zu -zc -ox -zq -i=/watcom/h -i=/watcom/h/win pvhook.c \
  ...
  && $W wlink system windows_dll name PVHOOK.DLL option heapsize=1024 file pvhook.obj \
       export PvCbtProc,PvCwpProc,PvMouseProc,PvHookInstall,PvHookRemove,PvHookSetShell,PvHookSetReal,PvHookSetDesktop,PvHookIsDead,PvHookTakeDirty,PvHookPopupAnchor,WEP \
